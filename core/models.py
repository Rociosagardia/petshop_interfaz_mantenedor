...
class Categoria (models.Model):
    ...
    nombreCategoria = models.CharField(max_length=80, blank=False, null=False, verbose_name="Categoria")
...
class Producto (models.Model):
    ...
    imagenProducto = models.ImageField(upload_to="images/", default="sinfoto.jpg", null=False, blank=False, verbose_name="Imagen del producto")#aca
